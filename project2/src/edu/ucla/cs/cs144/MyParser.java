...
class MyParser//Should be compatible with java file name
{
...
*/ 	
        	...
        	Seller_Location = getElementTextByTagNameNR(Item, "Location");//Seller_Location=Seller_Location.replaceAll("\"", "`"); //replace " to ` to avoid mismatch in MySQL
        	  if (Seller_Location=="") Seller_Location="\\N";
        	  //else Seller_Location=columnSeparator+Seller_Location+columnSeparator;
        	...
        	for (int p=0;p<SL_Attr.getLength();p++)
        	{
        	  ...
        	  if (Seller_Latitude=="") Seller_Latitude="\\N";
        	  if (Seller_Longitude=="") Seller_Longitude="\\N";
        	Seller_Country = getElementTextByTagNameNR(Item, "Country"); 
        	  if (Seller_Country=="") Seller_Country="\\N";
        	  //else Seller_Country=columnSeparator+Seller_Country+columnSeparator;
        	...
        	//Seller_UserID=Seller_UserID.replaceAll("\"", "`");//replace " to \" to avoid mismatch in MySQL
        	  if (Seller_UserID=="") Seller_UserID="\\N";
        	 // else Seller_UserID=columnSeparator+Seller_UserID+columnSeparator;
        	...
        	out1.write(ItemID+columnSeparator+Name+columnSeparator+strip(Currently)+columnSeparator+strip(Buy_Price)+columnSeparator+strip(First_Bid)+columnSeparator+Number_of_Bids+columnSeparator+
        	           Seller_Location +columnSeparator+Seller_Latitude+columnSeparator+Seller_Longitude+columnSeparator+Seller_Country+columnSeparator+
        			   stripDateTime(Started)+columnSeparator+stripDateTime(Ends)+columnSeparator+Seller_UserID+columnSeparator+Description+columnSeparator);
...
/*
  ...
  Below Construct Bidder(Bidder_UserID,Bidder_Rating,Bidder_Location,Bidder_Country)...4
*/
        	...
        	for (int i4=0;i4<Bid_List.length;i4++)
        	{
        		...
        		//Bidder_UserID=Bidder_UserID.replaceAll("\"", "`");//replace " to \" to avoid mismatch in MySQL
        		  if (Bidder_UserID=="") Bidder_UserID="\\N";
        		...
        		out3.write(ItemID+columnSeparator+Bidder_UserID+columnSeparator+stripDateTime(Time)+columnSeparator+strip(Amount)+columnSeparator);
        		out3.newLine();
        		out4.write(Bidder_UserID+columnSeparator+Bidder_Rating+columnSeparator+Bidder_Location+columnSeparator+Bidder_Country+columnSeparator);
        		out4.newLine();
...
//Below Construct Seller(Seller_UserID,Seller_Rating)...5        	
        	...
        	if (Seller_UserID=="") Seller_UserID="\\N";
        	//else Seller_UserID=columnSeparator+Seller_UserID+columnSeparator;
        	if (Seller_Rating=="") Seller_Rating="\\N";
