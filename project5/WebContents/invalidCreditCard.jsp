...
<html>
    <head>
        <title>Project 5 eBay Payment</title>
    ...
    <body>
        ...
        <div class= "PagePart">    
			...
			<div class="col-md-6 col-md-offset-3">
				...
				<br>
				<br>
				<form action="https://<%=serverName%>:<%=httpSecureServerPort%><%=getContextPath%>/session" method="POST">
					<table class="table table-hover">
						...
						<tr>
							...
							<td><input class="form-control" name="CreditCardNum" type="text" placeholder="Enter Credit Card:)"/></td>
						</tr>
					</table>
					<div class="text-center">
						<input class="btn btn-default btn-md" name="CreditCardSubmit" type="submit" value="Submit!" />
					</div>
				</form>
				<h2 class="text-center"> Sorry, your credit card number is invalid! </h2>
				<h3 class="text-center">Note: Credit card number must be 16 digits!</h3>
